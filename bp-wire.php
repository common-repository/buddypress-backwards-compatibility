...
require ( BPBC_PLUGIN_DIR . '/bp-wire/bp-wire-classes.php' );
require ( BPBC_PLUGIN_DIR . '/bp-wire/bp-wire-templatetags.php' );
require ( BPBC_PLUGIN_DIR . '/bp-wire/bp-wire-filters.php' );
